namespace GrapeCity.ActiveReports.Samples.Web.CodeReports
{
	...
	partial class InvoiceFiltered
	{
		...
		private void InitializeComponent()
		{
			...
			this.StartingDate = new GrapeCity.ActiveReports.SectionReportModel.Parameter();
			this.EndingDate = new GrapeCity.ActiveReports.SectionReportModel.Parameter();
			...
			this.imgLogo.ImageBase64String = resources.GetString("imgLogo.ImageBase64String");
			...
			// StartingDate
			// 
			this.StartingDate.DefaultValue = "1994-8-1";
			this.StartingDate.DisplayFormat = null;
			this.StartingDate.Key = "StartingDate";
			this.StartingDate.Prompt = "Starting Date:";
			this.StartingDate.PromptUser = true;
			this.StartingDate.QueryCreated = false;
			this.StartingDate.Tag = null;
			this.StartingDate.Type = GrapeCity.ActiveReports.SectionReportModel.Parameter.DataType.Date;
			// 
			// EndingDate
			// 
			this.EndingDate.DefaultValue = "1994-9-1";
			this.EndingDate.DisplayFormat = null;
			this.EndingDate.Key = "EndingDate";
			this.EndingDate.Prompt = "Ending Date:";
			this.EndingDate.PromptUser = true;
			this.EndingDate.QueryCreated = false;
			this.EndingDate.Tag = null;
			this.EndingDate.Type = GrapeCity.ActiveReports.SectionReportModel.Parameter.DataType.Date;
			// 
			// Detail
			// 
		...
		private SectionReportModel.Label Label;
		private SectionReportModel.Line Line1;
		private SectionReportModel.Line Line2;
		...
		private SectionReportModel.Label Label6;
		private SectionReportModel.Label Label7;
		private SectionReportModel.Label Label8;
		private SectionReportModel.Label Label4;
		private SectionReportModel.Label Label10;
		private SectionReportModel.Label Label11;
		private SectionReportModel.Label Label12;
		private SectionReportModel.TextBox txtShipDate;
		private SectionReportModel.Label Label13;
		private SectionReportModel.TextBox txtShipper;
		private SectionReportModel.GroupFooter GFOrderID;
		private SectionReportModel.Label Label9;
		private SectionReportModel.Label Label14;
		private SectionReportModel.Label Label15;
		...
		public GrapeCity.ActiveReports.SectionReportModel.Parameter StartingDate;
		public GrapeCity.ActiveReports.SectionReportModel.Parameter EndingDate;
	}
}